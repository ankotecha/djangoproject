...
SECRET_KEY = '$q1+f3#zd!an%#9y1rtpz(lwz-1)a55@w4^=*h8=1z_t4qx+n_'
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'has123'
EMAIL_HOST_PASSWORD = 'has12345#'
EMAIL_USE_TLS = True
...
DATABASES = {
   # 'default': {
	...
	'NAME' : 'codejam' , # Name of the database*
	'USER': 'ashish', #user name for the database
	'PASSWORD' : 'ashish2312#', # password
